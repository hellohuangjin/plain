...
let g:airline#themes#plain.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
let g:airline#themes#plain.insert_modified = copy(g:airline#themes#bubblegum#palette.normal_modified)
let g:airline#themes#plain.insert_paste = {
      \ 'airline_a': [s:gui_dark_gray, s:gui_orange, s:cterm_dark_gray, s:cterm_orange, ''],
      \ }

" Replace mode
let g:airline#themes#plain.replace = {
      ...
      \ }
let g:airline#themes#plain.replace_modified = copy(g:airline#themes#plain.insert_modified)
...
let g:airline#themes#plain.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
let g:airline#themes#plain.visual_modified = copy(g:airline#themes#plain.insert_modified)

" Inactive window
let s:IA = [s:gui_light_gray, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_hi, '']
let g:airline#themes#plain.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
let g:airline#themes#plain.inactive_modified = {
...
let g:airline#themes#plain.ctrlp = airline#extensions#ctrlp#generate_color_map(
